...
void main() {
  ...
  group('tests for UsersApi', () {
    ...
    test('test usersProfilesCreate', () async {
      // TODO
    });

    //Future usersProfilesDelete(int id, String userPk) async
    test('test usersProfilesDelete', () async {
      // TODO
    });

    //Future<List<WelfarebrothersUserProfile>> usersProfilesList(String userPk) async
    test('test usersProfilesList', () async {
      // TODO
    });

...
class FacilityForWorkerForWrite {
  ...
  @override
  String toString() => 'FacilityForWorkerForWrite[name=$name, category=$category, group=$group, careService=$careService, city=$city, prefecture=$prefecture, address=$address, building=$building, availableDaysOfTheWeek=$availableDaysOfTheWeek]';

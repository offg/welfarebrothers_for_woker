    ...
    try {
      switch (targetType) {
        ...
        case 'DayOffRequestForWrite':
          return DayOffRequestForWrite.fromJson(value);
        case 'Facility':
          return Facility.fromJson(value);
        case 'FacilityAdministration':
        ...
        case 'RoleAssignmentRequirement':
          return RoleAssignmentRequirement.fromJson(value);
        case 'RoleAssignmentRequirementForWrite':
          return RoleAssignmentRequirementForWrite.fromJson(value);
        case 'RoleForWrite':
          return RoleForWrite.fromJson(value);
        case 'Shift':
          return Shift.fromJson(value);
        case 'ShiftConfig':
          return ShiftConfig.fromJson(value);
        case 'ShiftConfigForWrite':
          return ShiftConfigForWrite.fromJson(value);
        case 'ShiftPattern':
        ...
        case 'WelfarebrothersUserProfileForWrite':
          return WelfarebrothersUserProfileForWrite.fromJson(value);
        case 'WorkSchedule':
          return WorkSchedule.fromJson(value);
        case 'WorkScheduleForWrite':
          return WorkScheduleForWrite.fromJson(value);
        case 'WorkScheduleSummary':
          return WorkScheduleSummary.fromJson(value);
        case 'WorkerProfile':
          return WorkerProfile.fromJson(value);
        case 'WorkerProfileForWrite':
          return WorkerProfileForWrite.fromJson(value);
        case 'WorkerStat':
          return WorkerStat.fromJson(value);
        case 'WorkingHoursConfig':
          return WorkingHoursConfig.fromJson(value);
        case 'WorkingHoursConfigForWrite':
          return WorkingHoursConfigForWrite.fromJson(value);
        default:
          Match match;
